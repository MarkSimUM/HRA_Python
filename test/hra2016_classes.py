...
# x = HRAData2016([{"demo_gender": 1, "demo_age": 22, "Demo_pregnant":""}]);
     ...
     def cleandata(self):
        ...
        record['sbio_bpdiastolic'] =  record['sbio_bpdiastolic'] if (record['sbio_bpdiastolic'] <= 1 ) else -6;
        record['sbio_choltc'] =  record['sbio_choltc'] if (record['sbio_choltc'] <= 1 ) else -6;
        record['sbio_cholhdl'] =  record['sbio_cholhdl'] if (record['sbio_cholhdl'] <= 1 ) else -6;
        record['sbio_cholldl'] =  record['sbio_cholldl'] if (record['sbio_cholldl'] <= 1 ) else -6;
        record['sbio_trig'] =  record['sbio_trig'] if (record['sbio_trig'] <= 1 ) else -6;
        record['sbio_glucose'] =  record['sbio_glucose'] if (record['sbio_glucose'] <= 1 ) else -6;
        record['sbio_hba1c'] =  record['sbio_hba1c'] if (record['sbio_hba1c'] <= 1 ) else -6;
        record['tob_cigsavgbeforequit'] =  record['tob_cigsavgbeforequit'] if (record['tob_cigsavgbeforequit'] <= 1 ) else -6;
        ...
        record['mdc_other'] =  record['mdc_other'] if (record['mdc_other'] <= 1 ) else -6;
        ...
        record['famhx_breastcancer'] =  record['famhx_breastcancer'] if (record['famhx_breastcancer'] <= 1 ) else -6;
